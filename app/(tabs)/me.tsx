...
export default function MeScreen() {
  ...
  const menuItems: MenuItem[] = [
    {
      icon: <Car size={20} color={Colors.primary} strokeWidth={1.5} />,
      label: t('me.vehicles'),
      onPress: () => router.push('/vehicles'),
    },
    {
      icon: <Tag size={20} color={Colors.primary} strokeWidth={1.5} />,
      label: t('me.vouchers'),
      onPress: () => router.push('/vouchers'),
    },
    {
      icon: <Star size={20} color={Colors.primary} strokeWidth={1.5} />,
      label: t('me.pointHistory'),
      ...
      >
        ...
        {loyalty && (
          ...
          >
            {[
              {
                label: t('me.stripPoints'),
                value: (loyalty.pointsBalance ?? 0).toLocaleString(),
              },
              {
                label: t('me.stripWashes'),
                value: loyalty.totalSuccessfulWashes.toString(),
              },
            ].map((item) => (
